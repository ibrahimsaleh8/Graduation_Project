  ...
  return (
    <SheetPortalPrimitive>
      ...
      <SheetContentPrimitive
        className={cn(
          "bg-background fixed z-1000 flex flex-col gap-4 shadow-lg",
        ...
        {children}
        {showCloseButton && (
          <SheetClose className="ring-offset-background focus:ring-ring cursor-pointer data-[state=open]:bg-secondary absolute top-2 right-2 bg-input-bg w-9 h-9 flex items-center justify-center  rounded-full opacity-80 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
