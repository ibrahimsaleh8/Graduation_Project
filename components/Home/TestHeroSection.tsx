...
export default function TestHeroSection() {
  return (
    <div className="w-full overflow-hidden md:px-10">
      <div className="relative md:pt-30 pt-10 pb-10 rounded-2xl overflow-hidden">
        <svg
        ...
        <div className="w-full flex flex-col relative gap-10 h-full min-h-[calc(100vh-15rem)] rounded-2xl px-1">
          {/* Stars */}

          <StarsRates />
          {/* Text */}
          <div className="text-center font-medium flex flex-col gap-7">
            <div className="xl:text-7xl lg:text-5xl md:text-4xl text-3xl text-center font-semibold flex items-center flex-col justify-center">
