      ...
      <div className="flex items-center flex-col md:flex-row md:gap-3 px-3 pl-5 w-full bg-white mx-auto md:rounded-full rounded-2xl border overflow-hidden">
        <div className="flex items-center p-2 w-full">
          ...
          <Input
            ...
            className="bg-white w-full md:h-13 h-10 border-0 focus-visible:ring-0 shadow-none focus-visible:border-0"
          />
        </div>
        ...
        <div className="flex items-center p-2 w-full">
          ...
          <Input
            ...
            className="bg-white md:h-13 h-10 w-full border-0 focus-visible:ring-0 shadow-none focus-visible:border-0"
          />
        </div>
